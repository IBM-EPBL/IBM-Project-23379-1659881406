...
COS_API_KEY_ID="1ctiyu19zgTjMaSj5RULdxYoAHiCt07j-kS6pxvjDpkS"
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/733853ffcfeb421896ffa5fa1ea6052e:c6e0b4b5-fde8-4d1d-b426-23a7a00823c9::"
...
@app.route('/')
def index():
    files = get_bucket_contents('bucket0007')
